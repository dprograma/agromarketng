...
const { getHostedDir }        = require('./src/services/mediaHostService');
...
// Serves ffmpeg-generated videos over a public URL so Instagram's Content
// Publishing API (which requires a fetchable video_url, not binary upload)
// can post them even when Replicate's own CDN URL isn't available.
app.use('/media', express.static(getHostedDir()));
