...
export const LeafIcon = ({ className, size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M2 22c1.25-1.25 2.5-2.5 3.5-4 .83-1.25 1.5-2.5 2-4 .5-1.5.83-3 1-4.5.17-1.5.17-3 0-4.5M2 22c0-4.5 1.5-8.5 4-12M2 22c3.5 0 7-1 10-3M12 19c-1.5-1.5-3-3-4-5s-1.5-4-1.5-6M17 12a5 5 0 0 0-5-5c-2 0-3.5.5-5 2"></path>
  </svg>
);
...
export const RecycleIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="m7.14 9.5 5.858.002"></path>
    <path d="M14.976 9.545 19.5 9.5l-1.634 7.528"></path>
    <path d="m18.17 9.5-2.313-3.954"></path>
  </svg>
);